        ...
        {isVisible && (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center fade-in">
            <div className="relative">
              ...
              <div className="absolute -bottom-6 -left-6 w-24 h-24 md:w-32 md:h-32 bg-orange-500 rounded-full -z-10"></div>
              <div className="absolute -top-6 -right-6 w-32 h-32 md:w-40 md:h-40 border-2 border-black rounded-full -z-10"></div>
            </div>
            
            <div>
              <h3 className="text-2xl font-bold mb-2">John Doe</h3>
              <p className="text-orange-500 font-medium mb-6">Founder & CEO</p>
